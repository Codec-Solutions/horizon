...
if (version_compare(PHP_VERSION, '7.4') === -1) {
    ...
    echo 'This version of Horizon requires at least PHP 7.4. ';
...
| Each Horizon application has an error handler that receives all 
...
| your Horizon application to a database.
|
*/
